  ...
  return (
    <main className="min-h-screen bg-white flex justify-center px-6 py-16">
      ...
      >
        ...
        <p className="mb-3">
          I'm an entrepreneur and writer. I'm currently studying economics &amp; philosophy at Georgetown SFS. Before college, I worked across a large range of institutions (law firm, ministry of defense, bank compliance, consumer retail, literacy non-profit, b2b leadership consulting) during a gap year where I really wanted autonomy and liked meeting interesting people.
        </p>
